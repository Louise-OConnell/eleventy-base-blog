...
document.getElementById('bill').onclick = function() {
    let myBill = parseFloat(document.getElementById(Value1).value);
    let tipPercent = 15;
...
<input type="text" id="Number" placeholder="Value1" oninput="myBill(this.value)" onoutput="totalBillWithTip">
<p id="bill"></p>
